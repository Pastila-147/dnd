...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.container-tasks {
  font-family: Arial, sans-serif;
  background-color: #31e1b8;
  display: flex;
  align-items: center;
...
.content_card[contenteditable="true"]:hover {
  cursor: text;
}
...
;// CONCATENATED MODULE: ./src/js/Trello DnD.js
class Task {
